...
const ostatniElementNumber = wezZGoryTablicyGeneric([1, 2, 3])    // number | undefined
...
const data2 = mapElementsToObjects([]) // ArrayItemType: number - z argumentu funkcji
...
// problem
// {
//   function getProperty(obj: {}, keyOfObj: string | number | symbol) {
//     return obj[keyOfObj];
//   }
...
const retStringFromOne = getProperty(1, 'toString')
// @ts-expect-error
